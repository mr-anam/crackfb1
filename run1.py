...
jalan('\033[1;96m    +++++++ JANGAN LUPA BUAT AKUN BARU +++++++ ')
jalan('\033[1;92m  +++++++ UNTUK MENGHINDARI SESI/CHECKPOINT +++++++ ')
jalan('\033[1;93m    +++++++ RECODE BY MR•ANAM +++++++ ')
logo = """ \033[1;96m
╭━━━╮╱╱╱╱╱╱╱╱╱╭━━━┳╮
╰╮╭╮┃╱╱╱╱╱╱╱╱╱┃╭━━┫┃
╱┃┃┃┣╮╭┳╮╭┳━━╮┃╰━━┫╰━╮
...
╱╱╱╱╱╱╱╱╱╱╰╯
\033[1;93m➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫
\033[1;97m• GITHUB    : Github.com/mr-anam
• FACEBOOK  : fb.me/Mr.anam46
• WHATSAPP  : 0895392866030
\033[1;94m➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫➫
"""
def tik():
	titik = ['.   ','..  ','... ']
...
def login():
	...
	try:
		...
		print logo
		print 1*"\033[1;91m••••••••••••••••••••••••••••••••••"
		print 1*"\33[1;97m   NOTE : WAJIB PAKAI AKUN BARU"
		print 1*"\033[1;91m••••••••••••••••••••••••••••••••••"
		print('\033[1;92m[☆] \x1b[1;96mLOGIN AKUN FACEBOOK ANDA \x1b[1;92m[☆]' )
		...
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91mAkun Anda sesi/checkpoint :(")
...
def menu():
	...
	print 1*" "
	print "\x1b[1;97m1.\x1b[1;96m Hack facebook MBF"
...
def super():
	...
	print "\x1b[1;97m2.\x1b[1;96m Crack dari id publik"
...
def pilih_super():
	...
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;97m[✸]\033[1;96m Crack Berjalan \033[1;97m"+o),;sys.stdout.flush();time.sleep(1)
	print
	print('\x1b[1;97m[!] \x1b[1;96mStop CTRL+Z')
	print 1*"\033[1;91m☠️ ════════════════════════════════ ☠️"
	print 1*"\033[1;92m JIKA DALAM 5 MENIT BELUM ADA HASIL "
	print 1*"    GUNAKAN MODE PESAWAT 5 DETIK "
	print 1*"\033[1;91m☠️ ════════════════════════════════ ☠️"
	...
	raw_input("\n\033[1;96m[\033[1;97m Keluar & ketik python2 pro.py \033[1;96m]")
	keluar()
